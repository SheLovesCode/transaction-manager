...
export default function TransactionTable({ transactions }: TransactionTableProps) {
    ...
    const [selectedTransaction, setSelectedTransaction] = useState<ExistingTransaction | null>(null);
    ...
    const handleUpdateTransaction = (updatedTransaction: ExistingTransaction) => {
        setRows((prevRows) => prevRows.map((row) => row.id === updatedTransaction.id ? updatedTransaction : row));
